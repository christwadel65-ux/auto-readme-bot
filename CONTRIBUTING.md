...
Merci de votre intérêt pour contribuer à auto-readme-bot ! 🎉

## Comment contribuer

### Signaler un bug

1. Vérifier que le bug n'a pas déjà été signalé dans les [Issues](https://github.com/christwadel65-ux/auto-readme-bot/issues)
2. Créer une nouvelle issue avec le template "Bug Report"
3. Fournir le maximum d'informations :
   - Version du projet
...
- \efactor:\ refactoring de code
- \	est:\ ajout de tests
- \chore:\ maintenance

### Code Style

- Suivre le [Standard Style](https://standardjs.com/)
- Utiliser \prettier\ pour le formatage
- Utiliser \slint\ pour le linting
